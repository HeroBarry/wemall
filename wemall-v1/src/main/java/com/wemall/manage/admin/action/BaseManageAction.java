...
public class BaseManageAction {
    ...
    public void test_email(HttpServletRequest request, HttpServletResponse response, String email){
    ...
    public void test_sms(HttpServletRequest request, HttpServletResponse response, String mobile) throws UnsupportedEncodingException {
    ...
    public void user_msg_save(HttpServletRequest request, HttpServletResponse response, String msg) throws HttpException, IOException {
